 ...
 * 選擇下棋位置
 * (空: 0, 黑: 1, 白: 2)
 * @param {number[][]} board 15x15 的棋盤
 * @param {number} stone 我方棋子顏色
 * @param {number} timer 該局我方剩餘時間
 * @return {[number, number]} [x, y] 該局下棋位置
 */
 ...
 * @param {number[][]} board 15x15 的棋盤
 * @param {number} i 觀看位置的列
 * @param {number} j 觀看位置的行
 * @param {number} stone 觀看方棋子顏色
 * @return {[number, boolean][]} [conti, empty][] 該方連續棋數及該方在這些棋之後是否有空位
 * @example
 *  board =
 *    [[0, 0, 0, 0, 2],
 *     [0, 0, 1, 1, 2],
